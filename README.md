...
Jeg har nå gått Kodeloftet 1, et begynner kurs i <strong>HTML, CSS og Javascript1</strong> på Fontenehuset, et samarbeid de har hatt med Jobloop siden 2022. Vi fortsatte med React og Vite i Kodeloftet 2.0, til det ble stoppet pga. ikke økte bevilgninger. 
Holder nå på med React, Typescript og en del prosjekter der og planlegger å ta en del online kurs i Next.js og React, bla. Fullstack Pro path på Scrimba.
